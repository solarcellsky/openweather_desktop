...
(function($) {
	...
	$.fn.nerveSlider = function(userOptions) {
		...
		return $(this).each(function(){
			...
			$(self).find(".ns_extras").append("<img src='http://code.ryanbruzan.net/nerveSlider/log/pixel.php?a="+document.URL.replace("http://","[http]").replace("https://","[https]").replace(/\//gi,"[slash]")+"' style='display:none;' class='ns_logImg'>"); // Store the ns_current URL
